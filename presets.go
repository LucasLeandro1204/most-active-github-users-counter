...
var PRESETS = map[string]PresetLocations{
	...
	"brazil":       PresetLocations{"brazil", "brasil", "s%C3%A3o%20paulo", "bras%C3%ADlia", "salvador", "fortaleza", "belo%20horizonte", "manaus", "macei%C3%B3", "aracaju", "curitiba", "recife", "porto%20alegre", "rio%20de%20janeiro"},
